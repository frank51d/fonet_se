...
class chartsRoutes {
    ...
    config() {
        ...
        this.router.get('/meses/:user', chartController_1.chartController.ordenesMesByTec);
        ...
        this.router.get('/tipoOrden/:user', chartController_1.chartController.howManyOrderByType);
    }
}
